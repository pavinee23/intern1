...
export default function ReceivePaymentPage(){
  ...
  const load=async()=>{const r=await fetch('/api/accounting/payment-vouchers'+"?voucher_type=receive&party_type=customer"+(search?'&q='+encodeURIComponent(search):''));const d=await r.json();if(d.ok)setData(d.data||[])}
  useEffect(()=>{load()},[])
