...
export default function DeleteAllowedPage() {
  const { L } = useLang()
      ...
      <div style={{ padding: 30 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 24, fontWeight: 700 }}>
            🗑️ {L('Delete Allowed Records', 'ลบบันทึกที่กำหนดให้สามารถลบได้')}
          </div>
          <div style={{ fontSize: 13, marginTop: 8, opacity: 0.9 }}>
            {L('Manage delete allowed records', 'จัดการลบบันทึกที่กำหนดให้สามารถลบได้')}
          </div>
        </div>
