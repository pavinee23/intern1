...
export default function DeleteVerifiedPage() {
  const { L } = useLang()
      ...
      <div style={{ padding: 30 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 24, fontWeight: 700 }}>
            🗑️ {L('Delete Verified Records', 'ลบบันทึกที่ตรวจสอบแล้ว')}
          </div>
          <div style={{ fontSize: 13, marginTop: 8, opacity: 0.9 }}>
            {L('Manage delete verified records', 'จัดการลบบันทึกที่ตรวจสอบแล้ว')}
          </div>
        </div>
