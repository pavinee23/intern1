      ...
      <body>
        <div className="page-container">
          ...
          <div className="no-print" style={{ textAlign: 'center', padding: '12px', background: '#f0f0f0' }}>
            ...
            <a href={`/Thailand/Admin-Login/power-calculator?calcID=${data.calcID}`} className="edit-button" style={{ marginLeft: 16, textDecoration: 'none' }}>
          ...
          <div className="report-footer">
            ...
            <div style={{ marginTop: '4px' }}>{L('K Energy Save Co., Ltd.', 'บริษัท เค เอ็นเนอร์จี เซฟ จำกัด')}</div>
          </div>
        </div>
      </body>
    </div>
