...
export default function SalesReturnPage(){
  ...
  const load=async()=>{const r=await fetch('/api/accounting/sales-invoices'+"?doc_type=return"+(search?'&q='+encodeURIComponent(search):''));const d=await r.json();if(d.ok)setData(d.data||[])}
  useEffect(()=>{load()},[])
  ...
  return(<AccWindow title={L('Sales Return','รับคืนสินค้า')}><div style={{padding:12}}>
