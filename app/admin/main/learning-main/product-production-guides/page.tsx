...
export default function ProductProductionGuidesPage() {
  return (
    <div style={{ minHeight: '100vh', background: '#f8fafc', padding: 24 }}>
      <div style={{ maxWidth: 1100, margin: '0 auto' }}>
        <h1 style={{ fontSize: 28, fontWeight: 800, color: '#111827', marginBottom: 8 }}>
          คู่มือเกี่ยวกับผลิตภัณฑ์และการผลิต
        </h1>
        <p style={{ color: '#6b7280', marginBottom: 20 }}>
          เลือกปุ่มเพื่อล็อกอินเข้าสู่ระบบที่เกี่ยวข้องกับผลิตภัณฑ์และการผลิต
        </p>
